...
try:
    ...
    class ScoobyReport: # type: ignore
        def __init__(
                self, 
                addditional: Optional[Union[types.ModuleType, List[types.ModuleType]]],
                core: List[str],
                optional: List[str],
                ncol: int,
                text_width: int,
...
class Report(ScoobyReport):
    ...
    def __init__(
            self, 
            add_pckg: Optional[Union[types.ModuleType, List[types.ModuleType], str, List[str]]] = None,
            ncol: int = 3, 
            text_width: int = 80, 
            sort: bool = False,
        ) -> None:
        ...
        # Mandatory packages.
        core: List[str] = ['numpy', 'scipy', 'pylops', 'pyproximal']
